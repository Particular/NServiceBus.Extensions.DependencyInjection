namespace NServiceBus
{
    ...
    /// <summary>
    /// An extension point for to create an endpoint in the start-up phase where the container is externally managed using Microsoft dependency injection abstraction.
    /// </summary>
